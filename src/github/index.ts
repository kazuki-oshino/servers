  ...
  try {
    ...
    switch (request.params.name) {
      ...
      case "list_pull_requests": {
        ...
        const pullRequests = await pulls.listPullRequests(args.owner, args.repo, {
          state: args.state,
          sort: args.sort,
      ...
      case "create_pull_request_review": {
        ...
        const review = await pulls.createPullRequestReview(args.owner, args.repo, args.pull_number, {
          body: args.body,
          event: args.event,
      ...
      case "merge_pull_request": {
        ...
        const result = await pulls.mergePullRequest(args.owner, args.repo, args.pull_number, {
      ...
      case "update_pull_request_branch": {
        ...
        const result = await pulls.updatePullRequestBranch(args.owner, args.repo, args.pull_number, args.expected_head_sha);
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
      }
